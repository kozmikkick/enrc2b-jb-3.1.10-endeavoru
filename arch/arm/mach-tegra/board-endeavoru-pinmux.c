...
static __initdata struct tegra_pingroup_config enterprise_pinmux_modem[] = {
#ifdef CONFIG_TRIPNDROID_PINMUX
...
static __initdata struct tegra_pingroup_config endeavoru_pinmux_common[] = {
	...
	I2C_PINMUX(DDC_SCL,             I2C4,        NORMAL,       NORMAL,     INPUT,  DISABLE,    DISABLE), // MHL_DDC_CLK
	I2C_PINMUX(DDC_SDA,             I2C4,        NORMAL,       NORMAL,     INPUT,  DISABLE,    DISABLE), // MHL_DDC_DATA

	I2C_PINMUX(PWR_I2C_SCL,         I2CPWR,      NORMAL,       NORMAL,     INPUT,  DISABLE,    DISABLE), // SYS_PWR_I2C_SCL
	I2C_PINMUX(PWR_I2C_SDA,         I2CPWR,      NORMAL,       NORMAL,     INPUT,  DISABLE,    DISABLE), // SYS_PWR_I2C_SDA
	/* OUT TripNRaVeR: 8x DRIVE patched */
...
#ifdef CONFIG_TRIPNDROID_PINMUX
	DEFAULT_PINMUX(SDMMC1_DAT1,     RSVD1,           NORMAL,       TRISTATE,   INPUT), // NFC_IRQ
#endif
#ifdef CONFIG_HTC_PINMUX
	...
	DEFAULT_PINMUX(SDMMC3_DAT4,     SDMMC3,          PULL_DOWN,    TRISTATE,   OUTPUT), // TripNRaVeR: patched
	DEFAULT_PINMUX(SDMMC3_DAT5,     SDMMC3,          PULL_DOWN,    TRISTATE,   OUTPUT), // TripNRaVeR: patched
	DEFAULT_PINMUX(SDMMC3_DAT6,     SDMMC3,          PULL_DOWN,    TRISTATE,   OUTPUT), // TripNRaVeR: patched
	DEFAULT_PINMUX(SDMMC3_DAT7,     SDMMC3,          PULL_DOWN,    TRISTATE,   OUTPUT), // TripNRaVeR: patched
	...
	DEFAULT_PINMUX(GPIO_PU1,        RSVD,            NORMAL,       TRISTATE,   INPUT),
	DEFAULT_PINMUX(GPIO_PU2,        RSVD,            NORMAL,       TRISTATE,   INPUT),
#ifdef CONFIG_HTC_PINMUX
...
#ifdef CONFIG_TRIPNDROID_PINMUX
	DEFAULT_PINMUX(GPIO_PBB0,       I2S4,            NORMAL,       NORMAL,     INPUT), // CAM_CAM1_RST
#endif
#ifdef CONFIG_HTC_PINMUX
...
#ifdef CONFIG_TRIPNDROID_PINMUX
	DEFAULT_PINMUX(GPIO_PBB7,       I2S4,            NORMAL,       NORMAL,     INPUT), // CAM_FRONT_CAM_STANDBY
#endif
#ifdef CONFIG_HTC_PINMUX
	...
	*/
...
#ifdef CONFIG_TRIPNDROID_PINMUX
	DEFAULT_PINMUX(LCD_D19,		RSVD2, 	         NORMAL,       NORMAL,     OUTPUT), // PLSENSOR
#endif
#ifdef CONFIG_HTC_PINMUX
	DEFAULT_PINMUX(LCD_D19,		RSVD, 	         NORMAL,       NORMAL,     OUTPUT), // PLSENSOR
#endif
	DEFAULT_PINMUX(LCD_D21,         RSVD2,           NORMAL,       NORMAL,     OUTPUT), // NFC_VEN
	DEFAULT_PINMUX(LCD_D22,         RSVD2,           NORMAL,       NORMAL,     OUTPUT), // NFC_DL_MODE
	DEFAULT_PINMUX(LCD_D23,         DISPLAYA,        NORMAL,       NORMAL,     INPUT), // CAM_V_CAM_VAA_2V85_EN
	...
	DEFAULT_PINMUX(LCD_WR_N,        DISPLAYA,        PULL_DOWN,    TRISTATE,   OUTPUT), // TripNRaVeR: patched
...
#endif
	DEFAULT_PINMUX(SPI1_SCK,        GMI,             PULL_UP,      NORMAL,     INPUT), // PWR_CHG_INT
	...
	DEFAULT_PINMUX(ULPI_DATA4,      RSVD,            NORMAL,       NORMAL,     INPUT), // BT UART CTS (wake up)
	...
	DEFAULT_PINMUX(CLK3_OUT,        EXTPERIPH3,      PULL_DOWN,    TRISTATE,   OUTPUT), // TripNRaVeR: patched
#ifdef CONFIG_TRIPNDROID_PINMUX
...
{
	tegra_drive_pinmux_config_table(endeavoru_drive_pinmux, ARRAY_SIZE(endeavoru_drive_pinmux));

	tegra_pinmux_config_table(endeavoru_pinmux_common, ARRAY_SIZE(endeavoru_pinmux_common));
	tegra_pinmux_config_table(enterprise_pinmux_modem, ARRAY_SIZE(enterprise_pinmux_modem));
